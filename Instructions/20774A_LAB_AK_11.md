...
06. If this is the first time you have singed in, complete the **Welcome to Language Understanding** page, and then click **Create new LUIS app**.
07. Click **Create new app**. 
